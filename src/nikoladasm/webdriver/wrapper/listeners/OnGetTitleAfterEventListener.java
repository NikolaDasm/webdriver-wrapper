...
@FunctionalInterface
public interface OnGetTitleAfterEventListener extends WebDriverEventListener<Void> {
	void onGetTitle(WebDriver driver, String title);

	@Override
	default void invoke(WebDriver driver, Void element, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetTitle(driver, (String) returnValue);
	}
