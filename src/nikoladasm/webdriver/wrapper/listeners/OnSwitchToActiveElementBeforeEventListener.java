...
@FunctionalInterface
public interface OnSwitchToActiveElementBeforeEventListener extends WebDriverEventListener<TargetLocator> {
	void onSwitchToActiveElement(WebDriver driver, TargetLocator targetLocator);
	...
	default void invoke(WebDriver driver, TargetLocator targetLocator, Object proxy, Method method, Object[] args, Object returnValue) {
		onSwitchToActiveElement(driver, targetLocator);
	}
