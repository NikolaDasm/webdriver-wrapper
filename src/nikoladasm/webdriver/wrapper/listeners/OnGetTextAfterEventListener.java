...
@FunctionalInterface
public interface OnGetTextAfterEventListener extends WebDriverEventListener<WebElement> {
	void onGetText(WebDriver driver, WebElement element, String text);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetText(driver, element, (String) returnValue);
	}
