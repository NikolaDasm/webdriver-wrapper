...
@FunctionalInterface
public interface OnExecuteAsyncScriptBeforeEventListener extends WebDriverEventListener<Void> {
	void onExecuteAsyncScript(WebDriver driver, String script, Object... args);

	@Override
	default void invoke(WebDriver driver, Void element, Object proxy, Method method, Object[] args, Object returnValue) {
		onExecuteAsyncScript(driver, (String) args[0], (Object[]) args[1]);
	}
