...
@FunctionalInterface
public interface OnSwitchToAlertBeforeEventListener extends WebDriverEventListener<TargetLocator> {
	void onSwitchToAlert(WebDriver driver, TargetLocator targetLocator);
	...
	default void invoke(WebDriver driver, TargetLocator targetLocator, Object proxy, Method method, Object[] args, Object returnValue) {
		onSwitchToAlert(driver, targetLocator);
	}
