...
@FunctionalInterface
public interface OnReleaseKeyEventListener extends WebDriverEventListener<Keyboard> {
	void onReleaseKey(WebDriver driver, Keyboard keyboard, CharSequence keyToRelease);

	@Override
	default void invoke(WebDriver driver, Keyboard keyboard, Object proxy, Method method, Object[] args, Object returnValue) {
		onReleaseKey(driver, keyboard, (CharSequence) args[0]);
	}
