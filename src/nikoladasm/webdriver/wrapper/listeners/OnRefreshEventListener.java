...
@FunctionalInterface
public interface OnRefreshEventListener extends WebDriverEventListener<Navigation> {
	void onRefresh(WebDriver driver, Navigation navigation);

	@Override
	default void invoke(WebDriver driver, Navigation navigation, Object proxy, Method method, Object[] args, Object returnValue) {
		onRefresh(driver, navigation);
	}
