...
@FunctionalInterface
public interface OnIsSelectedBeforeEventListener extends WebDriverEventListener<WebElement> {
	void onIsSelected(WebDriver driver, WebElement element);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onIsSelected(driver, element);
	}
