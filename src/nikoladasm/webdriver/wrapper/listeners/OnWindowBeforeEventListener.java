...
@FunctionalInterface
public interface OnWindowBeforeEventListener extends WebDriverEventListener<Options> {
	void onWindow(WebDriver driver, Options options);

	@Override
	default void invoke(WebDriver driver, Options option, Object proxy, Method method, Object[] args, Object returnValue) {
		onWindow(driver, option);
	}
