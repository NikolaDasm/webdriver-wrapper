...
@FunctionalInterface
public interface OnGetRectBeforeEventListener extends WebDriverEventListener<WebElement> {
	void onGetRect(WebDriver driver, WebElement element);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetRect(driver, element);
	}
