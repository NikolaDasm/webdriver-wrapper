...
@FunctionalInterface
public interface OnNavigateAfterEventListener extends WebDriverEventListener <Void>{
	void onNavigate(WebDriver driver, Navigation navigation);

	@Override
	default void invoke(WebDriver driver, Void element, Object proxy, Method method, Object[] args, Object returnValue) {
		onNavigate(driver, (Navigation) returnValue);
	}
