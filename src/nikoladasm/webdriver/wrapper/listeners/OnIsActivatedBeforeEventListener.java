...
@FunctionalInterface
public interface OnIsActivatedBeforeEventListener extends WebDriverEventListener<ImeHandler> {
	void onIsActivated(WebDriver driver, ImeHandler imeHandler);

	@Override
	default void invoke(WebDriver driver, ImeHandler imeHandler, Object proxy, Method method, Object[] args, Object returnValue) {
		onIsActivated(driver, imeHandler);
	}
