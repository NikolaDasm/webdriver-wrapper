...
@FunctionalInterface
public interface OnGetCurrentUrlAfterEventListener extends WebDriverEventListener<Void> {
	void onGetCurrentUrl(WebDriver driver, String url);

	@Override
	default void invoke(WebDriver driver, Void element, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetCurrentUrl(driver, (String) returnValue);
	}
