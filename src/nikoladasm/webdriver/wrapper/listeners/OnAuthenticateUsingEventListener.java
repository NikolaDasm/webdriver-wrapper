...
@FunctionalInterface
public interface OnAuthenticateUsingEventListener extends WebDriverEventListener<Alert> {
	void onAuthenticateUsing(WebDriver driver, Alert alert, Credentials credentials);

	@Override
	default void invoke(WebDriver driver, Alert alert, Object proxy, Method method, Object[] args, Object returnValue) {
		onAuthenticateUsing(driver, alert, (Credentials) args[0]);
	}
