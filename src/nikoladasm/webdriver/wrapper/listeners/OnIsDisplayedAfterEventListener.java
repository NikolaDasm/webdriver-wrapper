...
@FunctionalInterface
public interface OnIsDisplayedAfterEventListener extends WebDriverEventListener<WebElement> {
	void onIsDisplayed(WebDriver driver, WebElement element, boolean isDisplayed);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onIsDisplayed(driver, element, (Boolean) returnValue);
	}
