...
@FunctionalInterface
public interface OnGetSizeBeforeEventListener extends WebDriverEventListener<WebElement> {
	void onGetSize(WebDriver driver, WebElement element);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetSize(driver, element);
	}
