...
@FunctionalInterface
public interface OnDoubleTapEventListener extends WebDriverEventListener<TouchScreen> {
	void onDoubleTap(WebDriver driver, TouchScreen touchScreen, Coordinates where);

	@Override
	default void invoke(WebDriver driver, TouchScreen touchScreen, Object proxy, Method method, Object[] args, Object returnValue) {
		onDoubleTap(driver, touchScreen, (Coordinates) args[0]);
	}
