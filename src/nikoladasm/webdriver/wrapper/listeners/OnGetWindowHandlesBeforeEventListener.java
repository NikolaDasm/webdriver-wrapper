...
@FunctionalInterface
public interface OnGetWindowHandlesBeforeEventListener extends WebDriverEventListener<Void> {
	void onGetWindowHandles(WebDriver driver);

	@Override
	default void invoke(WebDriver driver, Void element, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetWindowHandles(driver);
	}
