...
@FunctionalInterface
public interface OnGetAvailableEnginesAfterEventListener extends WebDriverEventListener<ImeHandler> {
	void onGetAvailableEngines(WebDriver driver, ImeHandler imeHandler, List<String> engines);
	...
	default void invoke(WebDriver driver, ImeHandler imeHandler, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetAvailableEngines(driver, imeHandler, unmodifiableList((List<String>) returnValue));
	}
