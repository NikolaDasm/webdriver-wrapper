...
@FunctionalInterface
public interface OnGetSizeAfterEventListener extends WebDriverEventListener<WebElement> {
	void onGetSize(WebDriver driver, WebElement element, Dimension size);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetSize(driver, element, (Dimension) returnValue);
	}
