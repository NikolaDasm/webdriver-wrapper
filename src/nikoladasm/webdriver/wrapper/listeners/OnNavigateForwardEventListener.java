...
@FunctionalInterface
public interface OnNavigateForwardEventListener extends WebDriverEventListener<Navigation> {
	void onForward(WebDriver driver, Navigation navigation);

	@Override
	default void invoke(WebDriver driver, Navigation navigation, Object proxy, Method method, Object[] args, Object returnValue) {
		onForward(driver, navigation);
	}
