...
@FunctionalInterface
public interface OnGetTextOfAlertAfterEventListener extends WebDriverEventListener<Alert> {
	void onGetText(WebDriver driver, Alert alert, String text);

	@Override
	default void invoke(WebDriver driver, Alert alert, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetText(driver, alert, (String) returnValue);
	}
