...
@FunctionalInterface
public interface OnLogsAfterEventListener extends WebDriverEventListener<Options> {
	void onLogs(WebDriver driver, Options options, Logs logs);

	@Override
	default void invoke(WebDriver driver, Options options, Object proxy, Method method, Object[] args, Object returnValue) {
		onLogs(driver, options, (Logs) returnValue);
	}
