...
@FunctionalInterface
public interface OnTouchDownEventListener extends WebDriverEventListener<TouchScreen> {
	void onTouchDown(WebDriver driver, TouchScreen touchScreen, int x, int y);

	@Override
	default void invoke(WebDriver driver, TouchScreen touchScreen, Object proxy, Method method, Object[] args, Object returnValue) {
		onTouchDown(driver, touchScreen, (int) args[0], (int) args[1]);
	}
