...
@FunctionalInterface
public interface OnIsSelectedAfterEventListener extends WebDriverEventListener<WebElement> {
	void onIsSelected(WebDriver driver, WebElement element, boolean isSelected);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onIsSelected(driver, element, (Boolean) returnValue);
	}
