...
@FunctionalInterface
public interface OnTouchMoveEventListener extends WebDriverEventListener<TouchScreen> {
	void onTouchMove(WebDriver driver, TouchScreen touchScreen, int x, int y);

	@Override
	default void invoke(WebDriver driver, TouchScreen touchScreen, Object proxy, Method method, Object[] args, Object returnValue) {
		onTouchMove(driver, touchScreen, (int) args[0], (int) args[1]);
	}
