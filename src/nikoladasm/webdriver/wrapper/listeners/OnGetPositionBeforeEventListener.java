...
@FunctionalInterface
public interface OnGetPositionBeforeEventListener extends WebDriverEventListener<Window> {
	void onGetPosition(WebDriver driver, Window window);

	@Override
	default void invoke(WebDriver driver, Window window, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetPosition(driver, window);
	}
