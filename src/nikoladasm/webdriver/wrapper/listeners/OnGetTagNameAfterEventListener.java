...
@FunctionalInterface
public interface OnGetTagNameAfterEventListener extends WebDriverEventListener<WebElement> {
	void onGetTagName(WebDriver driver, WebElement element, String tagName);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetTagName(driver, element, (String) returnValue);
	}
