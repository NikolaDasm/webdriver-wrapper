...
@FunctionalInterface
public interface OnSwitchToActiveElementAfterEventListener extends WebDriverEventListener<TargetLocator> {
	void onSwitchToActiveElement(WebDriver driver, TargetLocator targetLocator, WebElement element);
	...
	default void invoke(WebDriver driver, TargetLocator targetLocator, Object proxy, Method method, Object[] args, Object returnValue) {
		onSwitchToActiveElement(driver, targetLocator, (WebElement) returnValue);
	}
