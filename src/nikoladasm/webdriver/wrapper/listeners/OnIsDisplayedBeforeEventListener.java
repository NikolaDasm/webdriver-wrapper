...
@FunctionalInterface
public interface OnIsDisplayedBeforeEventListener extends WebDriverEventListener<WebElement> {
	void onIsDisplayed(WebDriver driver, WebElement element);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onIsDisplayed(driver, element);
	}
