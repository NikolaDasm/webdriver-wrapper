...
@FunctionalInterface
public interface OnGetAvailableLogTypesBeforeEventListener extends WebDriverEventListener<Logs> {
	void onGetAvailableLogTypes(WebDriver driver, Logs logs);

	@Override
	default void invoke(WebDriver driver, Logs logs, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetAvailableLogTypes(driver, logs);
	}
