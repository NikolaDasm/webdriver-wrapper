...
@FunctionalInterface
public interface OnImeAfterEventListener extends WebDriverEventListener<Options> {
	void onIme(WebDriver driver, Options options, ImeHandler imeHandler);

	@Override
	default void invoke(WebDriver driver, Options options, Object proxy, Method method, Object[] args, Object returnValue) {
		onIme(driver, options, (ImeHandler) returnValue);
	}
