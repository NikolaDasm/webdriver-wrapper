...
@FunctionalInterface
public interface OnIsEnabledBeforeEventListener extends WebDriverEventListener<WebElement> {
	void onIsEnabled(WebDriver driver, WebElement element);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onIsEnabled(driver, element);
	}
