...
@FunctionalInterface
public interface OnGetWindowHandleAfterEventListener extends WebDriverEventListener<Void> {
	void onGetWindowHandle(WebDriver driver, String handle);

	@Override
	default void invoke(WebDriver driver, Void element, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetWindowHandle(driver, (String) returnValue);
	}
