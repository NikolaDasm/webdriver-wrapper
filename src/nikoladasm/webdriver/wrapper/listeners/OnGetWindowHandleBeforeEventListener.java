...
@FunctionalInterface
public interface OnGetWindowHandleBeforeEventListener extends WebDriverEventListener<Void> {
	void onGetWindowHandle(WebDriver driver);

	@Override
	default void invoke(WebDriver driver, Void element, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetWindowHandle(driver);
	}
