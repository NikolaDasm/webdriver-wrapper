...
@FunctionalInterface
public interface OnLongPressEventListener extends WebDriverEventListener<TouchScreen> {
	void onLongPress(WebDriver driver, TouchScreen touchScreen, Coordinates where);

	@Override
	default void invoke(WebDriver driver, TouchScreen touchScreen, Object proxy, Method method, Object[] args, Object returnValue) {
		onLongPress(driver, touchScreen, (Coordinates) args[0]);
	}
