...
@FunctionalInterface
public interface OnGetLocationAfterEventListener extends WebDriverEventListener<WebElement>{
	void onGetLocation(WebDriver driver, WebElement element, Point point);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetLocation(driver, element, (Point) returnValue);
	}
