...
@FunctionalInterface
public interface OnGetTextBeforeEventListener extends WebDriverEventListener<WebElement> {
	void onGetText(WebDriver driver, WebElement element);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetText(driver, element);
	}
