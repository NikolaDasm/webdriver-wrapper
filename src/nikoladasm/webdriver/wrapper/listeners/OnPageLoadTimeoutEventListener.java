...
@FunctionalInterface
public interface OnPageLoadTimeoutEventListener extends WebDriverEventListener<Timeouts> {
	void onPageLoadTimeout(WebDriver driver, Timeouts timeouts, long time, TimeUnit unit);

	@Override
	default void invoke(WebDriver driver, Timeouts timeouts, Object proxy, Method method, Object[] args, Object returnValue) {
		onPageLoadTimeout(driver, timeouts, (long) args[0], (TimeUnit) args[1]);
	}
