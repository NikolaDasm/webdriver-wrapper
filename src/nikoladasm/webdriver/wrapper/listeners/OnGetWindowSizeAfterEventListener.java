...
@FunctionalInterface
public interface OnGetWindowSizeAfterEventListener extends WebDriverEventListener<Window> {
	void onGetSize(WebDriver driver, Window window, Dimension dimension);

	@Override
	default void invoke(WebDriver driver, Window window, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetSize(driver, window, (Dimension) returnValue);
	}
