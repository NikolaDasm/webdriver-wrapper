...
@FunctionalInterface
public interface OnSwitchToDefaultContentEventListener extends WebDriverEventListener<TargetLocator> {
	void onSwitchToDefaultContent(WebDriver driver, TargetLocator targetLocator);
	...
	default void invoke(WebDriver driver, TargetLocator targetLocator, Object proxy, Method method, Object[] args, Object returnValue) {
		onSwitchToDefaultContent(driver, targetLocator);
	}
