...
@FunctionalInterface
public interface OnMouseUpEventListener extends WebDriverEventListener<Mouse> {
	void onMouseUp(WebDriver driver, Mouse mouse, Coordinates where);

	@Override
	default void invoke(WebDriver driver, Mouse mouse, Object proxy, Method method, Object[] args, Object returnValue) {
		onMouseUp(driver, mouse, (Coordinates) args[0]);
	}
