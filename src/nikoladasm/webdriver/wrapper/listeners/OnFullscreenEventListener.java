...
@FunctionalInterface
public interface OnFullscreenEventListener extends WebDriverEventListener<Window> {
	void onFullscreen(WebDriver driver, Window window);

	@Override
	default void invoke(WebDriver driver, Window window, Object proxy, Method method, Object[] args, Object returnValue) {
		onFullscreen(driver, window);
	}
