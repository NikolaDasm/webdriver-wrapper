...
@FunctionalInterface
public interface OnDeleteAllCookiesEventListener extends WebDriverEventListener<Options> {
	void onDeleteAllCookies(WebDriver driver, Options options);

	@Override
	default void invoke(WebDriver driver, Options options, Object proxy, Method method, Object[] args, Object returnValue) {
		onDeleteAllCookies(driver, options);
	}
