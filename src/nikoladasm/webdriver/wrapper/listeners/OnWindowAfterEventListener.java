...
@FunctionalInterface
public interface OnWindowAfterEventListener extends WebDriverEventListener<Options> {
	void onWindow(WebDriver driver, Options options, Window window);

	@Override
	default void invoke(WebDriver driver, Options options, Object proxy, Method method, Object[] args, Object returnValue) {
		onWindow(driver, options, (Window) returnValue);
	}
