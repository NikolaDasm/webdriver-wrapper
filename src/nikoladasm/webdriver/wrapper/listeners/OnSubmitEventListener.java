...
@FunctionalInterface
public interface OnSubmitEventListener extends WebDriverEventListener<WebElement> {
	void onSubmit(WebDriver driver, WebElement element);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onSubmit(driver, element);
	}
	
	@Override
	default boolean isApplicable(Object obj, Class<?>[] parameterTypes) {
		return WebElement.class.isInstance(obj);
	}
}
