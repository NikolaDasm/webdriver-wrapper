...
@FunctionalInterface
public interface OnGetAvailableEnginesBeforeEventListener extends WebDriverEventListener<ImeHandler> {
	void onGetAvailableEngines(WebDriver driver, ImeHandler imeHandler);

	@Override
	default void invoke(WebDriver driver, ImeHandler imeHandler, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetAvailableEngines(driver, imeHandler);
	}
