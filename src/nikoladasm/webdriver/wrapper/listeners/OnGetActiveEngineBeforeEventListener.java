...
@FunctionalInterface
public interface OnGetActiveEngineBeforeEventListener extends WebDriverEventListener<ImeHandler> {
	void onGetActiveEngine(WebDriver driver, ImeHandler imeHandler);

	@Override
	default void invoke(WebDriver driver, ImeHandler imeHandler, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetActiveEngine(driver, imeHandler);
	}
