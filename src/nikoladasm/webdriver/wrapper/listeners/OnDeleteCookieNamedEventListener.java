...
@FunctionalInterface
public interface OnDeleteCookieNamedEventListener extends WebDriverEventListener<Options> {
	void onDeleteCookieNamed(WebDriver driver, Options options, String name);

	@Override
	default void invoke(WebDriver driver, Options options, Object proxy, Method method, Object[] args, Object returnValue) {
		onDeleteCookieNamed(driver, options, (String) args[0]);
	}
