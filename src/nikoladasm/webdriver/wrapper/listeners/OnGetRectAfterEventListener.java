...
@FunctionalInterface
public interface OnGetRectAfterEventListener extends WebDriverEventListener<WebElement> {
	void onGetRect(WebDriver driver, WebElement element, Rectangle rect);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetRect(driver, element, (Rectangle) returnValue);
	}
