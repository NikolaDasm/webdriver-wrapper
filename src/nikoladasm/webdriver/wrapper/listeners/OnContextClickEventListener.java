...
@FunctionalInterface
public interface OnContextClickEventListener extends WebDriverEventListener<Mouse> {
	void onContextClick(WebDriver driver, Mouse mouse, Coordinates where);

	@Override
	default void invoke(WebDriver driver, Mouse mouse, Object proxy, Method method, Object[] args, Object returnValue) {
		onContextClick(driver, mouse, (Coordinates) args[0]);
	}
