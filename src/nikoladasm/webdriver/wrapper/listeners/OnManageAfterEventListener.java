...
@FunctionalInterface
public interface OnManageAfterEventListener extends WebDriverEventListener <Void>{
	void onManage(WebDriver driver, Options options);

	@Override
	default void invoke(WebDriver driver, Void element, Object proxy, Method method, Object[] args, Object returnValue) {
		onManage(driver, (Options) returnValue);
	}
