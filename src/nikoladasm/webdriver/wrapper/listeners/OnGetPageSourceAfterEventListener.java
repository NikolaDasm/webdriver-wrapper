...
@FunctionalInterface
public interface OnGetPageSourceAfterEventListener extends WebDriverEventListener<Void> {
	void onGetPageSource(WebDriver driver, String source);

	@Override
	default void invoke(WebDriver driver, Void element, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetPageSource(driver, (String) returnValue);
	}
