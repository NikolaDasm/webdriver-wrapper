...
@FunctionalInterface
public interface OnExecuteScriptBeforeEventListener extends WebDriverEventListener<Void> {
	void onExecuteScript(WebDriver driver, String script, Object... args);

	@Override
	default void invoke(WebDriver driver, Void element, Object proxy, Method method, Object[] args, Object returnValue) {
		onExecuteScript(driver, (String) args[0], (Object[]) args[1]);
	}
