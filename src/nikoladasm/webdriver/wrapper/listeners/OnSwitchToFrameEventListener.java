...
@FunctionalInterface
public interface OnSwitchToFrameEventListener extends WebDriverEventListener<TargetLocator> {
	void onSwitchToFrame(WebDriver driver, TargetLocator targetLocator, Object frame);
