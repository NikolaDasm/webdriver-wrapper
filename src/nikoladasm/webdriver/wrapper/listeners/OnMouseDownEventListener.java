...
@FunctionalInterface
public interface OnMouseDownEventListener extends WebDriverEventListener<Mouse> {
	void onMouseDown(WebDriver driver, Mouse mouse, Coordinates where);

	@Override
	default void invoke(WebDriver driver, Mouse mouse, Object proxy, Method method, Object[] args, Object returnValue) {
		onMouseDown(driver, mouse, (Coordinates) args[0]);
	}
