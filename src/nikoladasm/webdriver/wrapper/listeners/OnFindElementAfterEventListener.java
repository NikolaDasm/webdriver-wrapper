...
@FunctionalInterface
public interface OnFindElementAfterEventListener extends WebDriverEventListener<WebElement> {
	void onFindElement(WebDriver driver, WebElement root, By by, WebElement element);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onFindElement(driver, element, (By) args[0], (WebElement) returnValue);
	}
