...
@FunctionalInterface
public interface OnGetLocationBeforeEventListener extends WebDriverEventListener<WebElement> {
	void onGetLocation(WebDriver driver, WebElement element);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetLocation(driver, element);
	}
