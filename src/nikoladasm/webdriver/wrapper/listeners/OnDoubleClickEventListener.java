...
@FunctionalInterface
public interface OnDoubleClickEventListener extends WebDriverEventListener<Mouse> {
	void onDoubleClick(WebDriver driver, Mouse mouse, Coordinates where);

	@Override
	default void invoke(WebDriver driver, Mouse mouse, Object proxy, Method method, Object[] args, Object returnValue) {
		onDoubleClick(driver, mouse, (Coordinates) args[0]);
	}
