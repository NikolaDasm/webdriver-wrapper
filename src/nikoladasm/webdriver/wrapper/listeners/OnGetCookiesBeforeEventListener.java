...
@FunctionalInterface
public interface OnGetCookiesBeforeEventListener extends WebDriverEventListener<Options> {
	void onGetCookies(WebDriver driver, Options options);

	@Override
	default void invoke(WebDriver driver, Options option, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetCookies(driver, option);
	}
