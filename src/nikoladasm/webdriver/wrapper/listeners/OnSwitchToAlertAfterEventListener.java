...
@FunctionalInterface
public interface OnSwitchToAlertAfterEventListener extends WebDriverEventListener<TargetLocator> {
	void onSwitchToAlert(WebDriver driver, TargetLocator targetLocator, Alert alert);
	...
	default void invoke(WebDriver driver, TargetLocator targetLocator, Object proxy, Method method, Object[] args, Object returnValue) {
		onSwitchToAlert(driver, targetLocator, (Alert) returnValue);
	}
