...
@FunctionalInterface
public interface OnExecuteScriptAfterEventListener extends WebDriverEventListener<Void> {
	void onExecuteScript(WebDriver driver, Object returnValue, String script, Object... args);

	@Override
	default void invoke(WebDriver driver, Void element, Object proxy, Method method, Object[] args, Object returnValue) {
		onExecuteScript(driver, returnValue, (String) args[0], (Object[]) args[1]);
	}
