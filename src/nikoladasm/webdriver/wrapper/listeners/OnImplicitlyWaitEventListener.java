...
@FunctionalInterface
public interface OnImplicitlyWaitEventListener extends WebDriverEventListener<Timeouts> {
	void onImplicitlyWait(WebDriver driver, Timeouts timeouts, long time, TimeUnit unit);

	@Override
	default void invoke(WebDriver driver, Timeouts timeouts, Object proxy, Method method, Object[] args, Object returnValue) {
		onImplicitlyWait(driver, timeouts, (long) args[0], (TimeUnit) args[1]);
	}
