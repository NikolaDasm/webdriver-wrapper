...
@FunctionalInterface
public interface OnTimeoutsBeforeEventListener extends WebDriverEventListener<Options> {
	void onTimeouts(WebDriver driver, Options options);

	@Override
	default void invoke(WebDriver driver, Options option, Object proxy, Method method, Object[] args, Object returnValue) {
		onTimeouts(driver, option);
	}
