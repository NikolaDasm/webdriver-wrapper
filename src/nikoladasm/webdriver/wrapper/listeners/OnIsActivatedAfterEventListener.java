...
@FunctionalInterface
public interface OnIsActivatedAfterEventListener extends WebDriverEventListener<ImeHandler> {
	void onIsActivated(WebDriver driver, ImeHandler imeHandler, boolean isActivated);

	@Override
	default void invoke(WebDriver driver, ImeHandler imeHandler, Object proxy, Method method, Object[] args, Object returnValue) {
		onIsActivated(driver, imeHandler, (boolean) returnValue);
	}
