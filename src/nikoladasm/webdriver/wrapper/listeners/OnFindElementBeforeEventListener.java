...
@FunctionalInterface
public interface OnFindElementBeforeEventListener extends WebDriverEventListener<WebElement> {
	void onFindElement(WebDriver driver, WebElement root, By by);

	@Override
	default void invoke(WebDriver driver, WebElement element, Object proxy, Method method, Object[] args, Object returnValue) {
		onFindElement(driver, element, (By) args[0]);
	}
