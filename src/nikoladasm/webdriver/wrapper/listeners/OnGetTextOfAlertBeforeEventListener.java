...
@FunctionalInterface
public interface OnGetTextOfAlertBeforeEventListener extends WebDriverEventListener<Alert> {
	void onGetText(WebDriver driver, Alert alert);

	@Override
	default void invoke(WebDriver driver, Alert alert, Object proxy, Method method, Object[] args, Object returnValue) {
		onGetText(driver, alert);
	}
